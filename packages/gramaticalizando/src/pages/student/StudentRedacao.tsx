      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1.3fr) minmax(0, 0.9fr)', gap: '2rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          <Card variant="elevated" padding="lg">
            ...
            {temas.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '3rem 1.5rem', backgroundColor: 'var(--bg-surface-2)', borderRadius: 'var(--radius-md)', border: '1px dashed var(--border-subtle)' }}>
                <PenTool size={40} style={{ color: 'var(--text-muted)', margin: '0 auto 0.75rem' }} />
                <h4 style={{ fontSize: '1.125rem', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '0.35rem' }}>
                  Nenhuma proposta temática aberta no momento
                </h4>
                <p style={{ fontSize: '0.875rem', color: 'var(--text-secondary)', maxWidth: '420px', margin: '0 auto' }}>
                  A Professora Wilma Barbosa publicará em breve os primeiros temas dissertativos e textos motivadores para redação. Fique atento às publicações da plataforma!
                </p>
              </div>
            ) : (
              <>
