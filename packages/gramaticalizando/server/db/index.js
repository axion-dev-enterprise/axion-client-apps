...
const defaultDbUrl = process.env.DATABASE_URL || 
    (process.env.POSTGRES_HOST
        ? `postgres://${process.env.POSTGRES_USER || 'axion'}:${process.env.POSTGRES_PASSWORD || 'PR9XCvjPgx58L0c7GrXLf9SceY5IjLzggS0rNzHJ7zsxjz1-'}@${process.env.POSTGRES_HOST}:${process.env.POSTGRES_PORT || 5432}/${process.env.POSTGRES_DB || 'gramaticalizando_db'}`
        : "postgres://axion:PR9XCvjPgx58L0c7GrXLf9SceY5IjLzggS0rNzHJ7zsxjz1-@100.73.36.87:5432/gramaticalizando_db");
