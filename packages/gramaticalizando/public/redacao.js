        ...
        try {
            ...
            temasContainer.innerHTML = temas.map(t => `
                <div class="tema-card" data-titulo="${encodeURIComponent(t.titulo)}">
                    ...
                    <span style="font-size: 0.8rem; color: #7c3aed; font-weight: 600; margin-top: 0.75rem; display: inline-flex; align-items: center; gap: 0.35rem;">Selecionar tema <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></span>
                </div>
            `).join("");
